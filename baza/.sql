...
CREATE TABLE IF NOT EXISTS `baza`.`kosarica` (
  ...
  UNIQUE INDEX `fk_id_uporabnik_UNIQUE` (`fk_id_uporabnik` ASC),
...
CREATE TABLE IF NOT EXISTS `baza`.`narocen_avto` (
  ...
  UNIQUE INDEX `kolicina_UNIQUE` (`kolicina` ASC),
  UNIQUE INDEX `fk_id_narocilo_UNIQUE` (`fk_id_kosarica` ASC),
  UNIQUE INDEX `fk_id_avto_UNIQUE` (`fk_id_avto` ASC),
...
CREATE TABLE IF NOT EXISTS `baza`.`dnevnik` (
  ...
  UNIQUE INDEX `id_dnevnik_UNIQUE` (`id_dnevnik` ASC),
  INDEX `fk_dnevnik_uporabnik1_idx` (`fk_id_uporabnik` ASC),
  CONSTRAINT `fk_id_uporabnik`
    FOREIGN KEY (`fk_id_uporabnik`)
    REFERENCES `baza`.`uporabnik` (`id_uporabnik`)
    ON DELETE NO ACTION
...
-- Table `baza`.`table1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `baza`.`table1` ;

CREATE TABLE IF NOT EXISTS `baza`.`table1` (
)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `baza`;
INSERT INTO `baza`.`uporabnik` (`id_uporabnik`, `ime`, `priimek`, `email`, `geslo`, `telefon`, `status`, `uloga`, `fk_id_naslov`) VALUES (1, 'Admin', 'Admin', 'admin@gmail.com', 'Admin123', NULL, 'aktiven', 'admin', DEFAULT);
INSERT INTO `baza`.`uporabnik` (`id_uporabnik`, `ime`, `priimek`, `email`, `geslo`, `telefon`, `status`, `uloga`, `fk_id_naslov`) VALUES (2, 'Emil', 'Batakliev', 'emil@gmail.com', 'Emil123', NULL, 'aktiven', 'prodajalec', DEFAULT);
INSERT INTO `baza`.`uporabnik` (`id_uporabnik`, `ime`, `priimek`, `email`, `geslo`, `telefon`, `status`, `uloga`, `fk_id_naslov`) VALUES (3, 'Maja', 'Nikoloska', 'maja@gmail.com', 'Maja123', NULL, 'blokiran', 'prodajalec', DEFAULT);
INSERT INTO `baza`.`uporabnik` (`id_uporabnik`, `ime`, `priimek`, `email`, `geslo`, `telefon`, `status`, `uloga`, `fk_id_naslov`) VALUES (4, 'Martin', 'Arsovski', 'martin@gmail.com', 'Martin123', NULL, 'aktiven', 'prodajalec', DEFAULT);
...
START TRANSACTION;
USE `baza`;
INSERT INTO `baza`.`dnevnik` (`id_dnevnik`, `vsebina`, `fk_id_uporabnik`) VALUES (1, 'Varnost 1', 1);
INSERT INTO `baza`.`dnevnik` (`id_dnevnik`, `vsebina`, `fk_id_uporabnik`) VALUES (2, 'Varnost 2', 2);
