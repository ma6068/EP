...
<body>
    <div>
        <div class="container spacing-bottom">
            <?php
                echo '<form class="form-signin" method="POST" action="avtoKolicinaController.php">';
            ?>
            <div class=" row flex-center">
		<div class="col-md-4 oblik-prijava">
                    <div class=" mt-4">
			<div class="color-bukvi">
                            <h2 class="card-title mt-2 text-center">Edit car's amount</h2>
			</div>
			<article class="card-body">
                            <form role="form">
                                <div class="form-group">
                                    <input id="kolicina" name="kolicina" placeholder="Amount" class="form-control" min="1" type="number">
                                </div>
