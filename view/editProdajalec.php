...
<head>
	...
	<meta charset="utf-8">
	<title>Prodajalec edit profile</title>
...
<body>
    <div>
        <div class="container spacing-bottom">
            <form class="form-signin" method="POST" action="editProdajalecController.php">
            <div class=" row flex-center">
		<div class="col-md-4 oblik-prijava">
                    <div class=" mt-4">
			<div class="color-bukvi">
                            <h2 class="card-title mt-2 text-center">Edit your profile</h2>
			</div>
