...
<head>
	...
	<meta charset="utf-8">
	<title>Prodajalec changes stranka status</title>
...
<body>
    <div>
        <div class="container spacing-bottom">
            <form class="form-signin" method="POST" action="prodajalecADClientController.php">
            <div class=" row flex-center">
		<div class="col-md-4 oblik-prijava">
                    <div class=" mt-4">
			<div class="color-bukvi">
                            <h2 class="card-title mt-2 text-center">Change client's status</h2>
			</div>
			<article class="card-body">
                            <form role="form">
                                ...
                                <div class="form-group">
                                    <input id="ime" name="status" placeholder="Status" class="form-control" type="text" maxlength="20">
                                </div>
